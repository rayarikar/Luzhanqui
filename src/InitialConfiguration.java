...
public class InitialConfiguration {
	...
	/**
	 * Initialize the map so that we can come to know the name of the piece
	 * based on the rank of the piece KEY -> Rank of the 
	 * piece VALUE -> Name of the piece
	 */
	static {
	...
	/**
	 * This method populates the positions of the player on the board.
	 */
	...
	/**
	 * This method prints the positions to the standard output in the 
	 * following format (A11) -> This means at position A1, the piece 
